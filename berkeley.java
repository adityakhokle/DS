...
{
public static void berkeleyAlgo(String mastertime, String time1, String time2,
String time3)
{
...
long slave3_difference = org_slave_3 - org_master;System.out.println("Differ in time between master and Slave 3 :"+slave3_difference/1000);
System.out.println("---------------------------------------------------------------------------------");
